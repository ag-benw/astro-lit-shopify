...
export class Header extends ThemeProvider {
  ...
  <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
    <div class="fixed inset-0 bg-black bg-opacity-25 ${this.active ? "" : "hidden"}"></div>

    <div class="fixed inset-0 z-40 flex ${this.active ? "" : "hidden"}">
        ...
        <div class="mt-2">
          <div class="border-b border-gray-200">
            <div class="-mb-px flex space-x-8 px-4" aria-orientation="horizontal" role="tablist">
              <button id="tabs-1-tab-1" class="border-transparent text-gray-900 flex-1 whitespace-nowrap border-b-2 py-4 px-1 text-base font-medium" aria-controls="tabs-1-panel-1" role="tab" type="button">Women</button>

              <button id="tabs-1-tab-2" class="border-transparent text-gray-900 flex-1 whitespace-nowrap border-b-2 py-4 px-1 text-base font-medium" aria-controls="tabs-1-panel-2" role="tab" type="button">Men</button>
            </div>
          </div>
            ...
            <div class="flex h-full space-x-8">
              <div class="flex">
                <div class="relative flex">
                  ...
                  <button type="button" class="text-gray-700 hover:text-gray-800 relative z-10 flex items-center justify-center text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">
                    Women
                ...
                <!--
                  ...
                  Leaving: "transition ease-in duration-150"
                    ...
                    To: "opacity-0"
                -->
                <div class="absolute inset-x-0 top-full ${this.active ? "" : "hidden"}">

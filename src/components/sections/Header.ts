...
import { CartDrawer } from "../functional/Cart";
...
export class Header extends ThemeProvider {
  ...
  handleQuantity() {
    ...
    this.cartQuantity = persistantCart?.totalQuantity || 0;
  }
  ...
  connectedCallback(): void {
    ...
    subscribe('cart-update:quantity', this.handleQuantity.bind(this))
  }
  ...
  render() {
    ...
    <div class="bg-white">
      <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
        <div class="fixed inset-0 bg-black bg-opacity-25 hidden"></div>
        ...
        <div class="fixed inset-0 z-40 hidden">
          <div class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
            ...
            <div class="mt-2">
              ...
              <div id="tabs-1-panel-1" class="space-y-10 px-4 pt-10 pb-8" aria-labelledby="tabs-1-tab-1" role="tabpanel"
                tabindex="0">
                <div class="space-y-4">
              ...
              <div id="tabs-1-panel-2" class="space-y-10 px-4 pt-10 pb-8" aria-labelledby="tabs-1-tab-2" role="tabpanel"
                tabindex="0">
                <div class="space-y-4">
                  <div class="group aspect-w-1 aspect-h-1 relative overflow-hidden rounded-md bg-gray-100">
            ...
            <div class="flex h-16 items-center justify-between">
              ...
              <div class="flex flex-1 items-center justify-end">
                ...
                <div class="ml-4 flow-root lg:ml-6">
                  <button type="button" class="group -m-2 flex items-center p-2" @click="${this.handleDrawer}">
                    ...
                    <span
                      class="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800">${this.cartQuantity}</span>
